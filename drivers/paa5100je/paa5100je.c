...
static void paa5100je_prop_init(const paa5100je_t *dev);

static void paa5100je_init_paa5100je(const paa5100je_t *dev);

static void paa5100je_init_pmw3901(const paa5100je_t *dev);

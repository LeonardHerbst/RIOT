 ...
 *
 * @see @ref UNICOAP_METHOD_FLAG and @ref UNICOAP_METHODS
 */
...
struct unicoap_listener {
     ...
     *
     * @see @ref unicoap_proto_set_t, @ref UNICOAP_PROTOCOL_FLAG, @ref UNICOAP_PROTOCOLS,
     * @ref UNICOAP_PROTOCOLS_ALLOW_ALL, and @ref UNICOAP_PROTOCOLS_ALLOW_NONE
     */
    unicoap_proto_set_t protocols;
};

#ifndef JERRYSCRIPT_STLG_H
#define JERRYSCRIPT_STLG_H
...
#  define LOG_STAGE_INIT()      jerryscript_stlg_init()
#  define LOG_STAGE(stage)      jerryscript_stlg_record(#stage)
#  define LOG_STAGE_PRINT()     jerryscript_stlg_print()
#endif
